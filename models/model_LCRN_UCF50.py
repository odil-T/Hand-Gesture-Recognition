...
with tf.device('/GPU:0'):
    ...
    model = tf.keras.Sequential([
        ...
        TimeDistributed(MaxPooling2D(padding='same')),
    ...
    model_name = f'model__date_time_{current_date_time_str}__loss_{model_eval_loss}__acc_{model_eval_acc}_LCRN_Nunchucks_JugglingBalls_PizzaTossing_PullUps.h5'
